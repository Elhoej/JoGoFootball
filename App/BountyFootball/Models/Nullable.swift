...
//  BountyFootball
//
//  Created by Simon Elhøj Steinmejer on 09/11/2023.
//
...
extension KeyedDecodingContainer {
    ...
    public func decode<Wrapped>(_ type: NullCodable<Wrapped>.Type, forKey key: KeyedDecodingContainer<K>.Key) throws -> NullCodable<Wrapped> where Wrapped: Decodable {
